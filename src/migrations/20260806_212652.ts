...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_categories_type" AS ENUM('income', 'expense');
  CREATE TYPE "public"."enum_accounts_type" AS ENUM('cash', 'bank', 'card', 'other');
  ...
  CREATE TABLE "accounts" (
  	...
  	"opening_date" timestamp(3) with time zone NOT NULL,
  	"active" boolean DEFAULT true,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "transactions" (
  	...
  	"category_id" integer,
  	"amount_in_cents" numeric NOT NULL,
  	"payment_method_id" integer,
  	"account_id" integer NOT NULL,
  	"destination_account_id" integer,
  	"guide_number" varchar,
  	"guide_amount_in_cents" numeric,
  	"notes" varchar,
  ...
  CREATE UNIQUE INDEX "accounts_name_idx" ON "accounts" USING btree ("name");
  ...
  CREATE UNIQUE INDEX "payment_methods_name_idx" ON "payment_methods" USING btree ("name");
  ...
  CREATE INDEX "transactions_destination_account_idx" ON "transactions" USING btree ("destination_account_id");
